    ...
    <div class="col-md-12">
        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col">
                        <form action="{{ route('admin.cari.surat-tugas') }}" method="get">
                            ...
                            <tr>
                                ...
                                <td>
                                                    ...
                                                    <form
                                                            ...
                                                            <div class="col">
                                                                <div class="form-group mb-2">
                                                                    ...
                                                                    <input type="text"
                                                                        ...
                                                                        value="{{ $datas->nomor_izin }}" disabled>
                                                                    @error('nomor_izin')
                                                                        <span class="invalid-feedback" role="alert">
                                                                            <strong>{{ $message }}</strong>
                                                                        </span>
                                                            ...
                                                            <div class="col">
                                                                <div class="form-group mb-2">
                                                                    ...
                                                                    <input type="text"
                                                                        ...
                                                                        value="{{ $datas->lingkup_kegiatan }}" disabled>
                                                            ...
                                                            <div class="col">
                                                                <div class="form-group mb-2">
                                                                    ...
                                                                    <input type="date"
                                                                        ...
                                                                        value="{{ $datas->tanggal_kegiatan }}" disabled>
                                                            ...
                                                            <div class="col">
                                                                <div class="form-group mb-2">
                                                                    ...
                                                                    <textarea type="text"
                                                                        ...
                                                                        value="" rows="3" disabled>{{ $datas->alamat }}</textarea>
                                                                    @error('alamat')
                                                                        <span class="invalid-feedback" role="alert">
                                                                            <strong>{{ $message }}</strong>
                                                                        </span>
                                                            ...
                                                            <div class="col">
                                                                <div class="form-group mb-2">
                                                                    ...
                                                                    <input type="text"
                                                                        ...
                                                                        value="{{ $datas->tempat_id }}" disabled>
                                                                    @error('tempat_id')
                                                                        <span class="invalid-feedback" role="alert">
                                                                            <strong>{{ $message }}</strong>
                                                                        </span>
                                                            ...
                                                            <div class="col">
                                                                <div class="form-group mb-2">
                                                                    ...
                                                                    <input type="text"
                                                                        ...
                                                                        value="{{ $datas->tanggal_ttd }}" disabled>
                                                                    @error('tanggal_ttd')
                                                                        <span class="invalid-feedback" role="alert">
                                                                            <strong>{{ $message }}</strong>
                                                                        </span>
                                                        ...
                                                        <div class="form-group mb-2">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                value="{{ $datas->nama_penandatangan }}" disabled>
                                    ...
                                    <a class="btn btn-danger btn-sm"
                                        href="{{ url('/admin/surat-tugas/delete/'.$datas->id) }}">Hapus</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
